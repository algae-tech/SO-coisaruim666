...
/* ---- Configuracao de escalonador (Trabalho de SO) ---- */
#define SCHED_ORIGINAL 0
#define SCHED_FCFS     1
#define SCHED_RR       2
...
/* >>> TROQUE ESTE NUMERO E RECOMPILE PARA ALTERNAR O ALGORITMO <<< */
#define SCHED_ALGO SCHED_PRIORITY
/* ------------------------------------------------------ */
...
struct proc {
  ...
  /* --- campos novos (Trabalho de SO) --- */
  int p_upriority;		/* prioridade estatica p/ escalon. Priority
				 * (0 = mais prioritario) */
  int p_tickets;		/* bilhetes p/ escalon. Lottery */
  long p_burst_estimate;	/* estimativa de rajada p/ escalon. SJF */
  long p_burst_start;		/* instante em que a rajada atual comecou */
  /* -------------------------------------- */
